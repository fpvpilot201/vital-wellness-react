      ...
      {lightboxOpen && (
        ...
        >
          ...
          <img
            ...
            alt={`iVital Wellness luxury rehab facility - ${allImages[currentImageIndex].split('/').pop()?.replace(/iVital-Wellness-/i, '').replace(/[-_]/g, ' ').replace(/\.\w+$/, '') || `photo ${currentImageIndex + 1}`}`}
