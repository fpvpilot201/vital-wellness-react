...
export const metadata: Metadata = {
  title: "Prescription Drug Rehab | iVital Wellness",
  description:
    "Prescription drug rehabilitation at iVital Wellness in Santa Clarita, CA. Recovery programs for opioid, benzo, and medication addiction.",
  alternates: { canonical: "/prescription-rehab" },
  openGraph: {
    title: "Prescription Drug Rehab | iVital Wellness",
    description: "Prescription drug rehabilitation at iVital Wellness in Santa Clarita, CA. Recovery programs for opioid, benzo, and medication addiction.",
    url: "/prescription-rehab",
...
<section class="page-hero">
    ...
    <div class="hero-content">
        <h1 class="page-title">Prescription Drug Rehabilitation</h1>
        <div class="hero-divider"><img src="/photos/leaves-1.svg" alt="Divider" style="height: 40px; width: auto;"></div>
        <p class="page-subtitle">Specialized Prescription Drug Recovery Programs</p>
    </div>
</section>
<div class="main-container">
    <div class="lower-split">
        <div class="content-col">
            <h2 class="content-heading">Specialized Care for Prescription Drug Addiction</h2>
            <p class="content-p">Prescription drug addiction is a growing concern that requires specialized treatment approaches. At iVital Wellness, we understand the unique challenges associated with prescription medication dependence, whether it involves opioids, benzodiazepines, stimulants, or other controlled substances. Our comprehensive rehabilitation programs are designed specifically to address the physical, psychological, and emotional aspects of prescription drug addiction.</p>
            <p class="content-p">Many individuals begin taking prescription medications for legitimate medical reasons, only to find themselves struggling with dependence and addiction. The path to recovery from prescription drug addiction requires understanding the underlying reasons for misuse, addressing any co-occurring mental health conditions, and developing healthy coping mechanisms. Our experienced team of addiction specialists, therapists, and medical professionals work together to create personalized treatment plans that address your specific needs and circumstances.</p>
            <h2 class="content-heading" style="font-size: 28px; margin-top: 40px;">Comprehensive Treatment Approach</h2>
            <p class="content-p">Our prescription drug rehabilitation programs combine medical care, individual therapy, group counseling, family therapy, and holistic treatments to provide a well-rounded approach to recovery. We utilize evidence-based therapies such as Cognitive Behavioral Therapy (CBT) to help you identify and change negative thought patterns, Dialectical Behavior Therapy (DBT) to manage intense emotions, and Motivational Interviewing to enhance your intrinsic motivation for change.</p>
            <p class="content-p">At iVital Wellness, we recognize that recovery from prescription drug addiction is a journey that extends beyond detox. Our residential programs provide a supportive, therapeutic environment where you can focus entirely on your healing. We also address pain management needs without relying on addictive substances, offering alternative treatments and therapies. With comprehensive aftercare planning and ongoing support, we help you build the foundation for a lasting recovery and a healthier, more fulfilling life free from prescription drug dependence.</p>
        </div>
...
export default function PrescriptionRehabPage() {
