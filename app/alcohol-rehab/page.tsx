...
export const metadata: Metadata = {
  title: "Alcohol Rehab Santa Clarita | iVital Wellness",
  description:
    "Comprehensive alcohol rehabilitation in Santa Clarita, CA. Evidence-based therapies including CBT, group therapy, and family counseling.",
  alternates: { canonical: "/alcohol-rehab" },
  openGraph: {
    title: "Alcohol Rehab Santa Clarita | iVital Wellness",
    description: "Comprehensive alcohol rehabilitation in Santa Clarita, CA. Evidence-based therapies including CBT, group therapy, and family counseling.",
    url: "/alcohol-rehab",
