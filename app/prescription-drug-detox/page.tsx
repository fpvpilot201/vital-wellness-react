...
export const metadata: Metadata = {
  title: "Prescription Drug Detox | iVital Wellness",
  description:
    "Medically supervised prescription drug detox at iVital Wellness. Opioid, benzo, and medication withdrawal management in Santa Clarita.",
  alternates: { canonical: "/prescription-drug-detox" },
  openGraph: {
    title: "Prescription Drug Detox | iVital Wellness",
    description: "Medically supervised prescription drug detox at iVital Wellness. Opioid, benzo, and medication withdrawal management in Santa Clarita.",
    url: "/prescription-drug-detox",
