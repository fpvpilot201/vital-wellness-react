...
export const metadata: Metadata = {
    title: "iVital Wellness Residential Treatment Center in Santa Clarita",
    description: "iVital Wellness Personalized Residential Treatment program in Santa Clarita is designed to meet your specific needs: Reclaim Your Future Today.",
    alternates: { canonical: "/residential-treatment" },
    openGraph: {
        title: "iVital Wellness Residential Treatment Center in Santa Clarita",
        description: "iVital Wellness Personalized Residential Treatment program in Santa Clarita is designed to meet your specific needs: Reclaim Your Future Today.",
        url: "/residential-treatment",
