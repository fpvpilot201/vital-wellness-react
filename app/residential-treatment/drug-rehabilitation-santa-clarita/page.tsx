...
export const metadata: Metadata = {
    title: "Drug Rehabilitation Centre in Santa Clarita: iVital Wellness",
    description: "iVital Wellness: Find top drug rehab centers in Santa Clarita. Explore luxury drug treatment options and nearby detox centers for personalized recovery",
    alternates: { canonical: "/residential-treatment/drug-rehabilitation-santa-clarita" },
    openGraph: {
        title: "Drug Rehabilitation Centre in Santa Clarita: iVital Wellness",
        description: "iVital Wellness: Find top drug rehab centers in Santa Clarita. Explore luxury drug treatment options and nearby detox centers for personalized recovery",
        url: "/residential-treatment/drug-rehabilitation-santa-clarita",
