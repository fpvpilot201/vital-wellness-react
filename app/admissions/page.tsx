...
export const metadata: Metadata = {
    title: "Admissions iVital Wellness Addiction Treatment in Santa Clarita",
    description: "At iVital Wellness, Our Commitment to your care is clear. We understand that entering rehab can be a daunting experience, especially if it’s your first time.",
...
const faqSchema = {
    ...
    mainEntity: [
        {
            "@type": "Question",
            name: "What is the admissions process at iVital Wellness?",
            acceptedAnswer: { "@type": "Answer", text: "The admissions process has three steps: (1) Initial Consultation with our 24/7 admissions counselor to discuss your needs, (2) Assessment and Insurance Verification to determine treatment options and coverage, and (3) Arrival and Intake where you meet your treatment team and begin your recovery journey at our Santa Clarita facility." }
        },
        {
            "@type": "Question",
            name: "How quickly can I be admitted to iVital Wellness?",
            acceptedAnswer: { "@type": "Answer", text: "Our admissions team is available 24/7. In many cases, we can complete your assessment and insurance verification same-day, enabling rapid admission when a bed is available at our Santa Clarita facility." }
        },
        {
            "@type": "Question",
            name: "What should I bring when I arrive at iVital Wellness?",
            acceptedAnswer: { "@type": "Answer", text: "We recommend packing comfortable clothing for your stay, personal hygiene items, and any necessary medications, which our medical team will review upon arrival. Our admissions team will provide you with a detailed packing list and guidelines to help you prepare." }
        },
        {
            "@type": "Question",
            name: "Does iVital Wellness accept insurance for addiction treatment?",
            acceptedAnswer: { "@type": "Answer", text: "Yes. We work with most major private insurance plans. Our admissions team will verify your insurance coverage and help you understand your benefits before you arrive, so you can focus entirely on your recovery." }
        },
        {
            "@type": "Question",
            name: "What happens during intake at iVital Wellness?",
            acceptedAnswer: { "@type": "Answer", text: "Upon arrival at our Santa Clarita facility, our team conducts a comprehensive intake assessment to understand your unique needs and create a personalized treatment plan. You will meet your medical staff, therapists, and the treatment team who will support you throughout your recovery." }
        },
    ],
};
