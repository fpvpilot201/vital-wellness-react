...
export const metadata: Metadata = {
    title: "Treatment Methods iVital Wellness Rehab in Santa Clarita, CA",
    description: "iVital Wellness Get safe Drug Detox, Alcohol Rehab, and care for Co-occurring Disorders in Santa Clarita. Explore our 30 to 90-day programs: Reclaim Your Future",
    alternates: { canonical: "/detox/treatment-methods" },
    openGraph: {
        title: "Treatment Methods iVital Wellness Rehab in Santa Clarita, CA",
        description: "iVital Wellness Get safe Drug Detox, Alcohol Rehab, and care for Co-occurring Disorders in Santa Clarita. Explore our 30 to 90-day programs: Reclaim Your Future",
        url: "/detox/treatment-methods",
